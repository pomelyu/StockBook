...
DIVIDEND_TYPES = ("CASH", "STOCK", "DRIP")
...
class Dividend(Base):
    ...
    dividend_type: Mapped[str] = mapped_column(String(10), nullable=False, default="CASH")
    amount: Mapped[Decimal] = mapped_column(Numeric(18, 6), nullable=False)
    currency: Mapped[str] = mapped_column(String(5), nullable=False)
    shares_received: Mapped[Decimal | None] = mapped_column(Numeric(18, 6), nullable=True)
